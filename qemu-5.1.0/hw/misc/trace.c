...
uint16_t _TRACE_EMPTY_SLOT_READ_DSTATE;
...
TraceEvent _TRACE_EMPTY_SLOT_READ_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "empty_slot_read",
    .sstate = TRACE_EMPTY_SLOT_READ_ENABLED,
    .dstate = &_TRACE_EMPTY_SLOT_READ_DSTATE 
};
