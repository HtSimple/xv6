...
extern TraceEvent _TRACE_PCI_NVME_ERR_INVALID_PRP2_MISSING_EVENT;
extern TraceEvent _TRACE_PCI_NVME_ERR_INVALID_PRP_EVENT;
extern TraceEvent _TRACE_PCI_NVME_ERR_INVALID_NS_EVENT;
...
extern uint16_t _TRACE_PCI_NVME_ERR_INVALID_PRP2_MISSING_DSTATE;
extern uint16_t _TRACE_PCI_NVME_ERR_INVALID_PRP_DSTATE;
extern uint16_t _TRACE_PCI_NVME_ERR_INVALID_NS_DSTATE;
...
#define TRACE_PCI_NVME_ERR_INVALID_PRP2_MISSING_ENABLED 1
#define TRACE_PCI_NVME_ERR_INVALID_PRP_ENABLED 1
#define TRACE_PCI_NVME_ERR_INVALID_NS_ENABLED 1
...
static inline void _nocheck__trace_pci_nvme_rw(const char * verb, uint32_t blk_count, uint64_t byte_count, uint64_t lba)
{
    if (trace_event_get_state(TRACE_PCI_NVME_RW) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:pci_nvme_rw " "%s %"PRIu32" blocks (%"PRIu64" bytes) from LBA %"PRIu64"" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
...
static inline void trace_pci_nvme_rw(const char * verb, uint32_t blk_count, uint64_t byte_count, uint64_t lba)
{
    if (true) {
        _nocheck__trace_pci_nvme_rw(verb, blk_count, byte_count, lba);
    }
}
...
static inline void _nocheck__trace_pci_nvme_identify_ns(uint16_t ns)
{
    if (trace_event_get_state(TRACE_PCI_NVME_IDENTIFY_NS) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:pci_nvme_identify_ns " "identify namespace, nsid=%"PRIu16"" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , ns);
    }
...
static inline void trace_pci_nvme_identify_ns(uint16_t ns)
{
    if (true) {
...
static inline void _nocheck__trace_pci_nvme_identify_nslist(uint16_t ns)
{
    if (trace_event_get_state(TRACE_PCI_NVME_IDENTIFY_NSLIST) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:pci_nvme_identify_nslist " "identify namespace list, nsid=%"PRIu16"" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , ns);
    }
...
static inline void trace_pci_nvme_identify_nslist(uint16_t ns)
{
    if (true) {
...
static inline void _nocheck__trace_pci_nvme_err_invalid_prplist_ent(uint64_t prplist)
{
    if (trace_event_get_state(TRACE_PCI_NVME_ERR_INVALID_PRPLIST_ENT) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:pci_nvme_err_invalid_prplist_ent " "PRP list entry is null or not page aligned: 0x%"PRIx64"" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , prplist);
    }
...
#define TRACE_PCI_NVME_ERR_INVALID_PRP2_MISSING_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_PCI_NVME_ERR_INVALID_PRP2_MISSING) || \
    false)

static inline void _nocheck__trace_pci_nvme_err_invalid_prp2_missing(void)
{
    if (trace_event_get_state(TRACE_PCI_NVME_ERR_INVALID_PRP2_MISSING) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:pci_nvme_err_invalid_prp2_missing " "PRP2 is null and more data to be transferred" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 );
    }
...
static inline void trace_pci_nvme_err_invalid_prp2_missing(void)
{
    if (true) {
        _nocheck__trace_pci_nvme_err_invalid_prp2_missing();
    }
}

#define TRACE_PCI_NVME_ERR_INVALID_PRP_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_PCI_NVME_ERR_INVALID_PRP) || \
    false)

static inline void _nocheck__trace_pci_nvme_err_invalid_prp(void)
{
    if (trace_event_get_state(TRACE_PCI_NVME_ERR_INVALID_PRP) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:pci_nvme_err_invalid_prp " "invalid PRP" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 );
    }
...
static inline void trace_pci_nvme_err_invalid_prp(void)
{
    if (true) {
        _nocheck__trace_pci_nvme_err_invalid_prp();
    }
}

#define TRACE_PCI_NVME_ERR_INVALID_NS_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_PCI_NVME_ERR_INVALID_NS) || \
    false)

static inline void _nocheck__trace_pci_nvme_err_invalid_ns(uint32_t ns, uint32_t limit)
{
    if (trace_event_get_state(TRACE_PCI_NVME_ERR_INVALID_NS) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:pci_nvme_err_invalid_ns " "invalid namespace %u not within 1-%u" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , ns, limit);
    }
...
static inline void trace_pci_nvme_err_invalid_ns(uint32_t ns, uint32_t limit)
{
    if (true) {
        _nocheck__trace_pci_nvme_err_invalid_ns(ns, limit);
    }
}
