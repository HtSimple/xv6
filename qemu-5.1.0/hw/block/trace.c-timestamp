...
uint16_t _TRACE_PCI_NVME_ERR_INVALID_PRP2_MISSING_DSTATE;
uint16_t _TRACE_PCI_NVME_ERR_INVALID_PRP_DSTATE;
uint16_t _TRACE_PCI_NVME_ERR_INVALID_NS_DSTATE;
...
TraceEvent _TRACE_PCI_NVME_ERR_INVALID_PRP2_MISSING_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "pci_nvme_err_invalid_prp2_missing",
    .sstate = TRACE_PCI_NVME_ERR_INVALID_PRP2_MISSING_ENABLED,
    .dstate = &_TRACE_PCI_NVME_ERR_INVALID_PRP2_MISSING_DSTATE 
};
TraceEvent _TRACE_PCI_NVME_ERR_INVALID_PRP_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "pci_nvme_err_invalid_prp",
    .sstate = TRACE_PCI_NVME_ERR_INVALID_PRP_ENABLED,
    .dstate = &_TRACE_PCI_NVME_ERR_INVALID_PRP_DSTATE 
};
TraceEvent _TRACE_PCI_NVME_ERR_INVALID_NS_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "pci_nvme_err_invalid_ns",
    .sstate = TRACE_PCI_NVME_ERR_INVALID_NS_ENABLED,
    .dstate = &_TRACE_PCI_NVME_ERR_INVALID_NS_DSTATE 
};
...
TraceEvent *hw_block_trace_events[] = {
    ...
    &_TRACE_PCI_NVME_ERR_INVALID_PRP2_MISSING_EVENT,
    &_TRACE_PCI_NVME_ERR_INVALID_PRP_EVENT,
    &_TRACE_PCI_NVME_ERR_INVALID_NS_EVENT,
