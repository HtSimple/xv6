...
uint16_t _TRACE_AVR_TIMER16_WRITE_IFR_DSTATE;
...
TraceEvent _TRACE_AVR_TIMER16_WRITE_IFR_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "avr_timer16_write_ifr",
    .sstate = TRACE_AVR_TIMER16_WRITE_IFR_ENABLED,
    .dstate = &_TRACE_AVR_TIMER16_WRITE_IFR_DSTATE 
};
...
TraceEvent *hw_timer_trace_events[] = {
    ...
    &_TRACE_AVR_TIMER16_WRITE_IFR_EVENT,
