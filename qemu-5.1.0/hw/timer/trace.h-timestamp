...
extern TraceEvent _TRACE_AVR_TIMER16_WRITE_IFR_EVENT;
...
extern uint16_t _TRACE_AVR_TIMER16_WRITE_IFR_DSTATE;
...
#define TRACE_AVR_TIMER16_WRITE_IFR_ENABLED 1
...
#define TRACE_AVR_TIMER16_WRITE_IFR_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_AVR_TIMER16_WRITE_IFR) || \
    false)

static inline void _nocheck__trace_avr_timer16_write_ifr(uint8_t value)
{
    if (trace_event_get_state(TRACE_AVR_TIMER16_WRITE_IFR) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:avr_timer16_write_ifr " "timer16 write addr:ifr value:%u" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , value);
    }
...
static inline void trace_avr_timer16_write_ifr(uint8_t value)
{
    if (true) {
        _nocheck__trace_avr_timer16_write_ifr(value);
    }
}
